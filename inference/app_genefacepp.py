...
def genefacepp_demo(
    ...
    with gr.Blocks(analytics_enabled=False) as genefacepp_interface:
        gr.Markdown("\
            <div align='center'> <h2> ChatFace </span> </h2> \
            <a style='font-size:18px;color: #a0a0a0' href='https://jack139.top'> Homepage </div>")
            ...
            with gr.Column(variant='panel'): 
                with gr.Tabs(elem_id="checkbox"):
                    with gr.TabItem('General Settings'):
                        gr.Markdown("need help? please visit our [best practice page](https://localhost) for more detials")
                        with gr.Column(variant='panel'):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--a2m_ckpt", type=str, default='checkpoints/audio2motion_vae')
    parser.add_argument("--postnet_ckpt", type=str, default='')
    parser.add_argument("--head_ckpt", type=str, default='')
    parser.add_argument("--torso_ckpt", type=str, default='') 
