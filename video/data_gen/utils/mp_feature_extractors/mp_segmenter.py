...
from video.utils.commons.multiprocess_utils import multiprocess_run_tqdm, multiprocess_run
...
class MediapipeSegmenter:
    def __init__(self):
        model_path = 'video/data_gen/utils/mp_feature_extractors/selfie_multiclass_256x256.tflite'
