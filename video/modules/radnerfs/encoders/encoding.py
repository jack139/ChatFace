...
def get_encoder(encoding, input_dim=3, 
    ...
    if encoding == 'None':
        ...
        from video.modules.radnerfs.encoders.freqencoder import FreqEncoder
        encoder = FreqEncoder(input_dim=input_dim, degree=multires)

    elif encoding == 'spherical_harmonics':
        from video.modules.radnerfs.encoders.shencoder import SHEncoder
        encoder = SHEncoder(input_dim=input_dim, degree=degree)

    elif encoding == 'hashgrid':
        from video.modules.radnerfs.encoders.gridencoder import GridEncoder
